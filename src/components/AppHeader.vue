  ...
  <header class="flex items-center justify-between">
    <div class="flex items-center gap-6">
      ...
      <div class="flex items-center gap-2">
        <button
          class="inline-flex rounded hover:bg-gray-200"
          @click="goToPrevWeek"
        >
    ...
    >
      <button
        class="hover:bg-gray-100 px-2 py-1 rounded-md transition"
      ...
      <Transition name="dropdown">
        ...
        >
          ...
          <a
            href="#"
            class="px-4 py-2 flex text-gray-900 text-sm hover:bg-gray-100 transition"
            @click="signOut"
          >Preferences</a>
          <a
            href="#"
